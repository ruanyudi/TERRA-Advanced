...
format shortg
[c, ~] = clock;
saveDir = ['Results' slash 'Test-' num2str(c(3)) '.' num2str(c(2)) '.' num2str(c(1)) '.' num2str(c(4)) '.' num2str(c(5)) '.' num2str(c(6)) slash];LKHdir = 'C:\\Users\\Group_node\\Downloads\\TERRA-random-analysis\\TERRA-main\\EstimatingHeuristic\\';
...
problem_params = struct('T',[],'R',0,'N',18,'D',6,'Home',[0;0],'Area',100,'Gp', []);
